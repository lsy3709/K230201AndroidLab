...
class MainActivity546 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button2.setOnClickListener {
            //공용저장소...........
            // projection -> select _ID, DISPLAY_NAME :특정 의 컬럼을 선택을 하는 항목.
            val projection = arrayOf(
                MediaStore.Images.Media._ID,
                MediaStore.Images.Media.DISPLAY_NAME
            )
            Log.d("lsy"," MediaStore.Images.Media._ID: ${MediaStore.Images.Media._ID},MediaStore.Images.Media.DISPLAY_NAME : ${MediaStore.Images.Media.DISPLAY_NAME} ")
            ...
            Log.d("lsy","MediaStore.Images.Media.EXTERNAL_CONTENT_URI: ${MediaStore.Images.Media.EXTERNAL_CONTENT_URI}")
            // cursor -> 공용저장소에 있는 사진의 이미지의 아이디와, 파일명을 불러옵니다.
            // 테이블 형식으로 데이터를 저장해놓음.
            cursor?.let {
                //cursor 는 0행부터 대기 -> moveToNext -> 1행으로 감.
                // 1행 마다, 컬럼이 id, displayname 으로 구성.
